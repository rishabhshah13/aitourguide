...
def plot_response_time_vs_length(data: List[Tuple[int, float]], file_path: str):
    ...
    if data:
        ...
        plt.figure(figsize=(12, 6))
        sns.scatterplot(x=lengths, y=times, color='coral', edgecolor='black', s=100, alpha=0.7)
...
def visualize_results(latencies: List[float], response_time_vs_length: List[Tuple[int, float]]):
